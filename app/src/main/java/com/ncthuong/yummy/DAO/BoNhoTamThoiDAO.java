package com.ncthuong.yummy.DAO;
...
import com.ncthuong.yummy.Database.DbHelper;
...
public class BoNhoTamThoiDAO {
    ...
    public BoNhoTamThoi getByName(String tenMonAn) {
        ...
        try {
            String[] columns = {BoNhoTamThoiContract.KEY_ID, BoNhoTamThoiContract.KEY_TEN_MON_AN, BoNhoTamThoiContract.KEY_SO_LUONG, BoNhoTamThoiContract.KEY_THANH_TIEN};
            String selection = BoNhoTamThoiContract.KEY_TEN_MON_AN + "=?";
            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                boNhoTamThoi.setTenMonAn(cursor.getString(cursor.getColumnIndex(BoNhoTamThoiContract.KEY_TEN_MON_AN)));
